...
class MultiheadAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask_future_timesteps=False,
        ...
        single_weight = attn_weights.view(bsz, self.num_heads, tgt_len, src_len)
        corresponding_hidden = v.contiguous().view(bsz, self.num_heads, src_len, self.head_dim)
        ...
        return attn, attn_weights, single_weight, corresponding_hidden
